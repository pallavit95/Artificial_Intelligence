...
def rule_based_opponent(game_array):
    global x_r_m, player1_moves, player2_moves
...
def click(game_array):
    global x_turn, o_turn, images, x_wins, o_wins, draw, epsilon
...
def train_q_learning(num_iterations, games_per_iteration, q_convergence_threshold=1e-6):
    global x_wins, o_wins, game_array, xo_draw, x_r_m, one, two, three, epsilon, player1_moves, player2_moves, alpha, gamma
    total_x_wins = 0
    total_o_wins = 0
    total_draws = 0
    ...
    for iteration in range(num_iterations):
        ...
        for _ in range(games_per_iteration):
            # if(iteration>=15 and iteration<=20):
            #     epsilon = 0.1
            #     alpha = 0.6
            #     gamma = 0.9
